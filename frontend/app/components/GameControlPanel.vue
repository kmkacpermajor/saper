...
const { disconnect, zoomIn, zoomOut, centerViewport, gameStarted, gameStatusMessage } = useGameSession();
  ...
  <div
    ...
    <div class="grid gap-3 md:grid-cols-[1fr_1fr_auto] md:items-center">
      <div class="flex flex-wrap items-center gap-2">
        ...
        <span class="rounded-md px-3 py-1 text-sm font-semibold" :class="gameStarted
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <button @click="disconnect(); navigateTo('/');"
